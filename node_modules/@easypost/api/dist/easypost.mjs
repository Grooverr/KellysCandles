    ...
    static _convertToEasyPostObject(t, e) {
      ...
      if (typeof t == "object" && t !== null) {
        ...
        if (R[t.object] !== void 0)
          s = new R[t.object]();
        else if (t.id !== void 0 && j[t.id.substr(0, t.id.indexOf("_"))] !== void 0) {
